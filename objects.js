//1.Given an array of objects, each object representing a person with a name and age property,write 
//a function that returns a new array containing the names of all people who are 18 years old or older.
const people = [
  { name: 'Alice', age: 17 },
  { name: 'Eunice', age: 22 },
  { name: 'Charlie', age: 14 },
...
const persons = getNamesOfAdults(people);
console.log(persons); 

//2.Write a function that takes an array of objects, where each object represents a product with 
//a name, price, and category property. The function should return an object that groups the products 
//by their categories, with the category names as keys and the arrays of products as values.
const products = [
...
function groupProductsInCategory(products) {
  const grouped = {};
...
var groupedProducts = groupProductsInCategory(products);
console.log(groupedProducts);

//3.Given an array of objects, where each object represents a student with a name and 
